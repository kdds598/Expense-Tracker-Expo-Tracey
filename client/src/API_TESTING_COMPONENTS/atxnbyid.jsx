...
import { useGetAccountTransactionQuery } from '../../Store/RTKqueries.js'; // Import the RTK query hook
...
const AccountTransactionDetails = () => {
  ...
  const { data, error, isLoading } = useGetAccountTransactionQuery(transactionId, {
  ...
  return (
    <div style={styles.container}>
      <h2>Fetch Account Transaction</h2>
