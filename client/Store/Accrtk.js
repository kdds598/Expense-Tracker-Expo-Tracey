...
//   tagTypes: ['Accounts', 'AccountTransactions'],
//   endpoints: (builder) => ({
...
//         providesTags:['Account','AccountTransactions'],
...
//   baseQuery: fetchBaseQuery({ baseUrl: 'http://localhost:3000/api' }), // Adjust the base URL as per your backend
//   tagTypes: ['Budgets', 'BudgetTransactions'],
//   endpoints: (builder) => ({
...
//   reducerPath: 'userinfoSlice', // You can customize the reducer path
//   baseQuery: fetchBaseQuery({ baseUrl: 'http://localhost:3000/api' }), // Adjust the base URL as per your backend
//   endpoints: (builder) => ({
...
// export const { useGetUserByUidQuery } = userinfoSlice; // Auto-generated hook
